...
if st.button("Analyze paper", type="primary"):
    if not uploaded_files:
        ...
        st.markdown(
            '<div class="section-heading"><span class="material-symbols-outlined">table_view</span><span>Paper breakdown</span></div>',
            unsafe_allow_html=True,
        )
        ...
        with right_col:
            st.markdown(
                '<div class="card-heading"><span class="material-symbols-outlined">repeat</span><span>Repeated questions</span></div>',
                unsafe_allow_html=True,
            )
